...
class ProductController extends Controller
{
   ...
   // câu 11 sua xoa san pham
    ...
    public function details_product(Request $request,$product_id){
        ...
        ->join('tbl_category_product','tbl_category_product.category_id','=','tbl_product.category_id')
        ->join('tbl_brand','tbl_brand.brand_id','=','tbl_product.brand_id')
        ->where('tbl_category_product.category_id',$details_product->category_id)->whereNotIn('tbl_product.product_slug',[$product_slug])->get();

        $manager_product  = view('pages.sanpham.show_details')->with('details_product',$details_product)->with('category',$cate_product)->with('brand',$brand_product)->with('relate',$related_product);

        //  return view('admin_layout')->with('admin.edit_product', $manager_product);
  
          return view('layout')->with('pages.sanpham.show_details', $manager_product)->with('category',$cate_product)->with('brand',$brand_product)->with('relate',$related_product);
